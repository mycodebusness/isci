...
export const columns: ColumnDef<Payment>[] = [
  {
    ...
    header: "Id",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("iduser")}</div>
    ),
  },
  {
    accessorKey: "nom",
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  href={`/dashboard/users/${row.original.iduser}`}
                >
              ...
              <TooltipContent className="flex gap-2 justify-center items-center">
                ...
                <p>modifier l&apos;utilisateur {row.original.nom}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="flex gap-2 justify-center items-center">
                  ...
                  <p>
                    supprimer l&apos;utilisateur {row.original.nom} dans le
                    système
                  </p>
                </TooltipContent>
              </Tooltip>
            ...
            <DialogContent>
              ...
              <DialogFooter className="justify-end">
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      await deleteUser(row.original.iduser);
                      toast({
                        title: "Supprimer",
    ...
    <div className="w-full px-4 pt-4">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          Total : {table.getFilteredRowModel().rows.length} utilisateur(s).
        </div>
